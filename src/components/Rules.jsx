  ...
  return (
    <div className="rules-container">
      <div className="rules-section">
        ...
        <div className="rules-content pt-3 text-left">
          <ol className = 'list-decimal'>
            <li>The hackathon will run for 24 hours nonstop from 14th(9am) to 16th(9am) of Ashad.</li>
      ...
      <div className="rules-section">
        ...
        <div className="rules-content pt-3  text-left">
        <ol className = 'list-decimal'>
            <li>Each team has to involve at least 2 members and can go up to 3 members.</li>
